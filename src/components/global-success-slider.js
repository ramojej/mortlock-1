                ...
                <div className="col-md-6">
                  <div className={ (playVideo && slideIndex === index ) ? "videoWrapper video--playing" : "videoWrapper" }>
                    ...
                    <div className="video__play">
                      <div className="text__wrap" data-id={index} role="button" tabIndex={0} onKeyDown={(event)=>funPlayVideo(index)} onClick={(event)=>funPlayVideo(index)}>
                ...
                <div className="col-md-6">
                  <div className="successText">
                    ...
                    <div className="control_wrapper">
                      <button className="slick-arrow slick-prev" onKeyDown={ () => gotoPrev() } onClick={()=>gotoPrev()}><span className="text">Prev</span><svg className="icon" width="100pt" height="100pt" version="1.1" viewBox="0 0 100 100"><path d="m87.5 45.832h-58.75l17.918-17.914-5.8359-5.8359-27.914 27.918 27.914 27.918 5.8359-5.8359-17.918-17.914h58.75z"/></svg></button>
                      <button className="slick-arrow slick-next" onKeyDown={ () => gotoNext() } onClick={()=>gotoNext()}><span className="text">Next</span><svg className="icon" width="100pt" height="100pt" version="1.1" viewBox="0 0 100 100"><path d="m12.5 45.832h64.582v8.332h-64.582z"/><path d="m59.168 77.918l-5.8359-5.8359 22.086-22.082-22.086-22.082 5.8359-5.8359 27.914 27.918z"/></svg></button>
                    </div>
                  </div>
                </div>
              </div>
