            ...
            <div className="row">
              <div className="col-sm-7 col-md-4 col-lg-3">
                ...
                <div className="socials">
                  ...
                  <ul className="social-networks">
                    <li><a rel="noopener" target="_blank" href="https://www.facebook.com/mortlocktimber/"><span className="text">Facebook</span><svg className="icon" height="512" viewBox="0 0 24 24" width="512"><path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z"/></svg></a></li>
              ...
              <div className="col-sm-5 col-md-4 col-lg-3">
                ...
                <ul className="footer_menu">
                  ...
                  <li><a href="https://goo.gl/maps/6JHxh3bahg2erXJXA" target="_blank" rel="noreferrer">Cunderdin WA 6407</a></li>
                  <li><a href="tel:1800894400">1800 894 400</a></li>
                </ul>
              </div>
            </div>
          </div>
