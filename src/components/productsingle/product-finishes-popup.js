                ...
                content.map((finish, index) => (
                  <div className="col-sm-3" key={index}>
                    <div className="finish__box">
                      ...
                      <span className="finish__title">Burnt ash black ash oiled</span>
                    </div>
                  </div>
                ))
              : null }
