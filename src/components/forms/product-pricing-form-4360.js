...
class ProductPricingForm extends Component {
  ...
  handleSubmit = async (event) => {
    ...
    const formLink = 'https://mortlock.dilatedigital.com.au/wp-json/contact-form-7/v1/contact-forms/4360/feedback';
        ...
        <>
          <form className={submitActive ? 'pricing__form loading' : 'pricing__form'} id="pricing__form" type="POST" onSubmit={ this.handleSubmit } noValidate>
            ...
            <div className="btn_wrap">
              ...
              <button className="button blackoutline" onClick={ this.pricingPopup }>know exactly what you’re looking for? click here</button>
